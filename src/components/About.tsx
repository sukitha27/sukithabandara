  ...
  return (
    <section className="py-24 px-6 relative" id="about">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-start">
        <div>
          <h2 className="font-headline text-2xl sm:text-3xl font-bold mb-8 flex items-center gap-4">
          ...
          <div className="space-y-6 text-on-surface-variant leading-relaxed">
            ...
            <div className="pt-6">
              <div className="bg-surface-container-lowest rounded-xl p-6 border border-outline-variant/10 font-mono text-sm overflow-x-auto">
                ...
                <p className="text-on-surface whitespace-nowrap md:whitespace-normal">14:23:05 up 365 days, 14:02, 1 user, load average: 0.05, 0.03, 0.01</p>
                <p className="text-primary-container mt-2">$ whoami</p>
                <p className="text-on-surface whitespace-nowrap md:whitespace-normal">sukitha_bandara</p>
              </div>
            </div>
          </div>
        </div>
